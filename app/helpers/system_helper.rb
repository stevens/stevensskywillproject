...
#    end 
    winners = [User.find_by_id(2297), User.find_by_id(2395), User.find_by_id(2223)]
    system_notice += " 告示：以下几位<em class='l3'><a href='http://www.beecook.com/elections/1/profile'>第一届蜂厨美味大赏</a></em> 的获奖蜂友，请尽快在 <em class='l3'><a href='http://www.beecook.com/settings/profile'>档案设置</a></em> 中登记联系信息，以便发送礼品： <br /><br />
                      <em class='l3'><a href='http://www.beecook.com/users/1690/profile' target='_blank'>趴趴熊</a></em>、<em class='l3'><a href='http://www.beecook.com/users/1573/profile' target='_blank'>Johnny的女儿</a></em>、<em class='l3'><a href='http://www.beecook.com/users/1399/profile' target='_blank'>Apple爱自己</a></em>、<em class='l3'><a href='http://www.beecook.com/users/1612/profile' target='_blank'>球球爱妈妈</a></em>！查看<em class='l2'><a href='http://www.beecook.com/elections/1/elect_winners' target='_blank'>获奖名单</a></em><br /><br />
                      <em class='l2'><a href='http://blog.sina.com.cn/s/blog_5eb976840100eifm.html' target='_blank'>爱心食谱行动</a></em> （第一季）进行中，恭喜 <em class='l2'><a href='#{user_first_link(winners[0])}' target='_blank'>#{user_username(winners[0], true, true)}</a></em>、<em class='l2'><a href='#{user_first_link(winners[1])}' target='_blank'>#{user_username(winners[1], true, true)}</a></em>、<em class='l2'><a href='#{user_first_link(winners[2])}' target='_blank'>#{user_username(winners[2], true, true)}</a></em> 获得第9月度爱心奖！<br /><br />
