module RecipesHelper
  ...
  def love_recipe_stats_set(user = nil, current = Time.now, start_at = '2009-08-01 00:00:00', end_at = '2010-07-31 23:59:59')
    ...
    if current >= start_at.to_time && current <= end_at.to_time
      ...
      awards = [ [1163, 1186, 272], [1606, 1399, 25], [1798, 1606, 1579], [1787, 1677, 399], [1798, 253, 1581], [1787, 1822, 1218], [2377, 1618, 2365], [2385, 2395, 2388], [2297, 2395, 2223], [2429, 2297, 2486] ]
      1.upto(12) do |i|
