class AddMatchFields < ActiveRecord::Migration
  def self.up
  	add_column :matches, :photos_lower_limit, :integer #参赛作品图片数量的下限要求
  	add_column :matches, :chars_lower_limit, :integer #参赛作品字符数量的下限要求
  ...
  def self.down
  	remove_column :matches, :photos_lower_limit
  	remove_column :matches, :chars_lower_limit
